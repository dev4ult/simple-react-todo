function Card({ children, className }) {
  return (
    <div
      className={`${className} card bg-gradient-to-br  from-white/50 to-white/10 rounded-lg backdrop-blur-lg  max-w-md relative z-10 border-2 border-t-white/40 border-l-white/40 border-r-white/10 border-b-white/10 group overflow-hidden shadow-sm `}
    >
